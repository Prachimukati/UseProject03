								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="paymentAmount"
											...
											oninput="handleIntegerInput(this, 'paymentAmountError', 7)"
											onblur="validateIntegerInput(this, 'paymentAmountError', 7)"
											value="<%=DataUtility.getStringData(dto.getPaymentAmount()).equals("0") ? ""
					: DataUtility.getStringData(dto.getPaymentAmount())%>">
									</div>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="datepicker" name="dateApplied"
											...
											readonly="readonly"
											+										value="<%=DataUtility.getDateString(dto.getDateApplied())%>">
