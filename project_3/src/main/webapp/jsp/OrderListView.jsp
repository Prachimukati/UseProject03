			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="productName"
						...
						oninput="handleLetterInput(this, 'productNameError', 30)"
						onblur="validateLetterInput(this, 'productNameError', 30)"
						value="<%=ServletUtility.getParameter("productName", request)%>">


					<font color="red" class="pl-sm-5" id="productNameError"></font>
				</div>
				<div class="col-sm-2">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">OrderDate</th>
							<th width="15%" class="text">Quantity</th>
							<th width="15%" class="text">Customer</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=map.get(Integer.parseInt(dto.getCustomer()))%></td>
