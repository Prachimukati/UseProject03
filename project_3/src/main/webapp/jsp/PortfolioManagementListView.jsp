...
<%@page
	import="in.co.rays.project_3.controller.PortfolioManagementListCtl"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PORTFOLIOMANAGEMENT_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto"
			...
			<%
				Map map = (Map) request.getAttribute("rktl");
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="portfolioName"
						placeholder="Enter portfolioName" class="form-control"
						oninput="handleLetterInput(this, 'portfolioNameError', 30)"
						onblur="validateLetterInput(this, 'portfolioNameError', 30)"
				...
				<div class="col-sm-2">
					<input type="text" name="initialInvestmentAmount"
						placeholder="Enter initialInvestmentAmount" class="form-control"
						oninput="handleIntegerInput(this, 'initialInvestmentAmountError', 30)"
						onblur="validateIntegerInput(this, 'initialInvestmentAmountError', 30)"
				...
				<div class="col-sm-2">
					<input type="text" name="investmentStrategy"
						placeholder="Enter investmentStrategy" class="form-control"
						oninput="handleLetterInput(this, 'investmentStrategyError', 30)"
						onblur="validateLetterInput(this, 'investmentStrategyError', 30)"
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=PortfolioManagementListCtl.OP_SEARCH%>"> &emsp;
					<input type="submit" class="btn btn-dark btn-md"
						style="font-size: 15px" name="operation"
						value="<%=PortfolioManagementListCtl.OP_RESET%>">
				</div>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">PortfolioManagement
					List</h1>
			</center>
			</br>
			<div class="row">
