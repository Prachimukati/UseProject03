							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									...
									<input type="text" name="portfolioName" placeholder="Enter portfolioName"
											...
											rows="5" cols="5" value="<%=DataUtility.getStringData(dto.getPortfolioName())%>">	

									</div>
								</div>

								<font color="red" class="pl-sm-5" id="portfolioNameError">
									<%=ServletUtility.getErrorMessage("portfolioName", request)%></font></br> 
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="initialInvestmentAmount"
											...
											oninput="handleIntegerInput(this, 'initialInvestmentAmountError', 7)"
											onblur="validateIntegerInput(this, 'initialInvestmentAmountError', 7)"
       ...
       <span class="pl-sm-5"><b>InvestmentStrategy</b> <span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<textarea name="investmentStrategy" placeholder="Enter investmentStrategy"
											class="form-control"
											oninput="handleLetterInput(this, 'investmentStrategyError', 200)"
											onblur="validateLetterInput(this, 'investmentStrategyError', 200)"
											onkeypress="return validateInput(event)" rows="5" cols="5"><%=DataUtility.getStringData(dto.getInvestmentStrategy())%></textarea>

									</div>
								</div>

								<font color="red" class="pl-sm-5" id="investmentStrategyError"> <%=ServletUtility.getErrorMessage("investmentStrategy", request)%></font></br>
		
								
								
								<span class="pl-sm-5"><b>RiskToleranceLevel</b> <span style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
