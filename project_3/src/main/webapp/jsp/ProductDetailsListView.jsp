...
<title>ProductDetails List</title>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCTDETAILS_LIST_CTL%>"
			method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" id="datepicker" name="dateOfPerchase"
						...
						readonly="readonly"
						value="<%=ServletUtility.getParameter("dateOfPerchase", request)%>">
				...
				<div class="col-sm-2">
					...
					<font color="red" class="pl-sm-5" id="priceError"></font>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">DateOfPerchase</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getDateOfPerchase())%></td>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">ProductDetails List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
