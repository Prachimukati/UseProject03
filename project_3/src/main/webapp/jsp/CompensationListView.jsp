...
<%@page import="in.co.rays.project_3.controller.CompensationListCtl"%>
<%@page import="in.co.rays.project_3.dto.CompensationDTO"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.COMPENSATION_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.CompensationDTO"
			...
			<%
				...
				Iterator<CompensationDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
				<h1 class="text-secondary font-weight-bold pt-3">
					<u>Compensation List</u>
				</h1>
			</center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<font color="red" class="pl-sm-5" id="paymentAmountError"></font>
             ...
             <div class="col-sm-2">
					<%=HTMLUtility.getList2("state", String.valueOf(dto.getState()), map1)%>
				</div>
				...
				<center>
					<div class="col-sm-2">
						<input type="submit" class="btn btn-primary btn-md"
							...
							value="<%=CompensationListCtl.OP_SEARCH%>"> &emsp; <input
							type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
							name="operation" value="<%=CompensationListCtl.OP_RESET%>">
					</div>
				</center>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: purple;">
							...
							<th width="15%" class="text">staffMember</th>
							<th width="20%" class="text">paymentAmount</th>
							<th width="15%" class="text">dateApplied</th>
							<th width="15%" class="text">state</th>
					...
					<tbody>
						...
						<td class="text"><%=map.get(Integer.parseInt(dto.getStaffMember()))%></td>

							<td class="text"><%=dto.getPaymentAmount()%></td>
							<td class="text"><%=DataUtility.getDateString(dto.getDateApplied())%></td>
							
						<td class="text"><%=map1.get(Integer.parseInt(dto.getState()))%></td>
													
													<td class="text"><a
								href="CompensationCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=CompensationListCtl.OP_NEXT%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Compensation List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=CompensationListCtl.OP_BACK%>">
				</div>
