					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								...
								<%
									Map map = (Map) request.getAttribute("cust");
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="productName"
											...
											oninput="handleLetterInput(this, 'productNameError', 25)"
											onblur="validateLetterInput(this, 'productNameError', 25)"
											rows="5" cols="5"
								...
								<font color="red" class="pl-sm-5" id="productNameError"> <%=ServletUtility.getErrorMessage("productName", request)%></font></br>
  ...
  <span class="pl-sm-5"><b>OrderDate</b> <span
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										class="form-control" placeholder="Enter orderDate"
										readonly="readonly"
...
<span class="pl-sm-5"><b>Customer</b> <span style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text">
										...
										<%=HTMLUtility.getList1("customer", String.valueOf(dto.getCustomer()), map)%>

									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("customer", request)%></font></br>
