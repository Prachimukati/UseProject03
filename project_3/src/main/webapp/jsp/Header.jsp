				...
				<!-- <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<%-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.Employee_CTL%>"> <i
							class="fas fa-user-circle"></i>Add Emplo
...
<a class="dropdown-item" href="<%=ORSView.INVENTORY_CTL%>"> <i
							class="far fa-file"></i>Add Inventory
						</a> <a class="dropdown-item" href="<%=ORSView.INVENTORY_LIST_CTL%>">
							<i class="fas fa-paste"></i>Inventory List
...
<a class="dropdown-item" href="<%=ORSView.PORTFOLIOMANAGEMENT_CTL%>"> <i
							class="far fa-file"></i>Add PortfolioManagement
						</a> <a class="dropdown-item" href="<%=ORSView.PORTFOLIOMANAGEMENT_LIST_CTL%>">
							<i class="fas fa-paste"></i>PortfolioManagement List
			
		
			<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">ProductDetails</font>
							</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="<%=ORSView.PRODUCTDETAILS_CTL%>"> <i
							class="far fa-file"></i>Add ProductDetails
						</a> <a class="dropdown-item" href="<%=ORSView.PRODUCTDETAILS_LIST_CTL%>">
							<i class="fas fa-paste"></i>ProductDetails List
...
<a class="dropdown-item" href="<%=ORSView.COMPENSATION_CTL%>"> <i
							class="far fa-file"></i>Add Compensation
						</a> <a class="dropdown-item" href="<%=ORSView.COMPENSATION_LIST_CTL%>">
							<i class="fas fa-paste"></i>Compensation List
...
<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"> <i
							class="far fa-file"></i>Add Order
						</a> <a class="dropdown-item" href="<%=ORSView.ORDER_LIST_CTL%>">
							<i class="fas fa-paste"></i>Order List


<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Customer</font>
							</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="<%=ORSView.CUSTOMER_CTL%>"> <i
							class="far fa-file"></i>Add Customer
						</a> <a class="dropdown-item" href="<%=ORSView.CUSTOMER_LIST_CTL%>">
							<i class="fas fa-paste"></i>Customer List
...
<a class="dropdown-item" href="<%=ORSView.TRANSPORTATION_CTL%>"> <i
							class="far fa-file"></i>Add Transportation
						</a> <a class="dropdown-item" href="<%=ORSView.TRANSPORTATION_LIST_CTL%>">
							<i class="fas fa-paste"></i>Transportation List
...
<a class="dropdown-item" href="<%=ORSView.MEDICATION_CTL%>"> <i
							class="far fa-file"></i>Add Medication
						</a> <a class="dropdown-item" href="<%=ORSView.MEDICATION_LIST_CTL%>">
							<i class="fas fa-paste"></i>Medication List
...
<a class="dropdown-item" href="<%=ORSView.CLIENT_CTL%>"> <i
							class="far fa-file"></i>Add Client
						</a> <a class="dropdown-item" href="<%=ORSView.CLIENT_LIST_CTL%>">
							<i class="fas fa-paste"></i>Client List
					
	
			<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: black;">Owner</font>
