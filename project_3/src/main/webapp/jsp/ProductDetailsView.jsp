					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div>
								...
								<%
								Map map = (Map) request.getAttribute("categoryyy");
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5" id="descriptionError"> <%=ServletUtility.getErrorMessage("description", request)%></font></br>
								  ...
								  <span class="pl-sm-5"><b>DateOfPerchase</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" id="datepicker" name="dateOfPerchase"
										class="form-control" placeholder="Enter dateOfPerchase"
										readonly="readonly"
										value="<%=DataUtility.getDateString(dto.getDateOfPerchase())%>">


									</div>

								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("dateOfPerchase", request)%></font></br> 
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="price"
											...
											value="<%=DataUtility.getStringData(dto.getPrice()).equals("0") ? ""
					: DataUtility.getStringData(dto.getPrice())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5" id="priceError">
									<%=ServletUtility.getErrorMessage("price", request)%></font></br>
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=ProductDetailsCtl.OP_RESET%>">
								</div>
