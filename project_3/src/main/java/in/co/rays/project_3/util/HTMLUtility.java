...
*/
	...
	public static String getList2(String name, String selectedVal, Map<Integer, String> map) {
		...
		StringBuilder sb = new StringBuilder("<select style='width: 210px;  height: 35px;'  class='form-control' name='" + name + "'>");
		...
		if (select) {
			...
			// Add placeholder option
			sb.append(
					"<option  style='width: 210px;  height: 35px;' class='dropdown-item' selected value=''>------Select a---- " + name + "--------</option>");
